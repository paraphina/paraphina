...
> **See also:** [WHITEPAPER.md § Auditability and Reproducibility](WHITEPAPER.md#auditability-and-reproducibility) — operator runbook, CI gate requirements, and verification path semantics.
