...
mod tests {
    ...
    fn v2_live_ranked_admission_micro_canary_profile_has_required_caps() {
        ...
        assert_eq!(canary.venue.as_ref().and_then(|venue| venue.base_order_size), Some(0.009));
        assert_eq!(canary.venue.as_ref().and_then(|venue| venue.max_order_size), Some(0.009));
