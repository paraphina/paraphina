...
def _common_target_fields(label: dict[str, Any]) -> dict[str, Any]:
    return {
        ...
        "order_id_hash": label.get("order_id_hash"),
        "client_order_id_hash": label.get("client_order_id_hash"),
        "decision_id_hash": label.get("decision_id_hash"),
        "venue_id": str(label.get("venue_id") or "unknown").lower(),
        "side": label.get("side"),
        "price": label.get("price"),
        "size": label.get("size"),
        "first_fill_time_ms": label.get("first_fill_time_ms"),
        "last_fill_time_ms": label.get("last_fill_time_ms"),
