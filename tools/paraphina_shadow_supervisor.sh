...
env \
  ...
  PARAPHINA_HL_STATE_STALE_MS_OVERRIDE=${PARAPHINA_HL_STATE_STALE_MS_OVERRIDE:-1500} \
  PARAPHINA_EXTENDED_STATE_STALE_MS_OVERRIDE=${PARAPHINA_EXTENDED_STATE_STALE_MS_OVERRIDE:-1500} \
